...
use ReservationBundle\Entity\Place;
use ReservationBundle\Form\PlaceType;
...
class PlaceController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ReservationBundle:Place')->findAll();
     ...
     * @Method("POST")
     * @Template("ReservationBundle:Place:new.html.twig")
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ReservationBundle:Place')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("ReservationBundle:Place:edit.html.twig")
     */
